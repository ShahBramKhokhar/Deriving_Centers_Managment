...
namespace ManagementSystem
{
    ...
    public class ManagementSystemCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            Configuration.MultiTenancy.IsEnabled = AppConstants.MultiTenancyEnabled;
            ...
            Configuration.Localization.Languages.Add(new LanguageInfo("fr", "Français", "famfamfam-flags fr"));
            
            Configuration.Settings.SettingEncryptionConfiguration.DefaultPassPhrase = AppConstants.DefaultPassPhrase;
            SimpleStringCipher.DefaultPassPhrase = AppConstants.DefaultPassPhrase;
        }
